...
dotenv.config();
const { CONSUMER_CHAIN_ENDPOINT, CONSUMER_CHAIN_ID, CONSUMER_MNEMONIC, CONSUMER_PREFIX, CONSUMER_TOKEN, SECRET_CHAIN_ENDPOINT, SECRET_CHAIN_ID, SECRET_MNEMONIC } = process.env;
